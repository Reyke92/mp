...
class City(models.Model):
    city_id = UnsignedBigAutoField(primary_key=True, db_column='city_id')
...
class State(models.Model):
    state_id = UnsignedBigAutoField(primary_key=True, db_column='state_id')
...
class Timezone(models.Model):
    timezone_id = UnsignedBigAutoField(primary_key=True, db_column='timezone_id')
