...
class Category(models.Model):
    category_id = UnsignedBigAutoField(primary_key=True, db_column='category_id')
...
class Attribute(models.Model):
    attribute_id = UnsignedBigAutoField(primary_key=True, db_column='attribute_id')
...
class AttributeValueType(models.Model):
    value_type_id = UnsignedBigAutoField(primary_key=True, db_column='value_type_id')
...
class AllowedAttributeValue(models.Model):
    allowed_value_id = UnsignedBigAutoField(primary_key=True, db_column='allowed_value_id')
...
class ItemCondition(models.Model):
    condition_id = UnsignedBigAutoField(primary_key=True, db_column='condition_id')
