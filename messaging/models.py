...
class Conversation(models.Model):
    conversation_id = UnsignedBigAutoField(primary_key=True, db_column='conversation_id')
    user_a = models.ForeignKey(settings.AUTH_USER_MODEL, models.RESTRICT, db_column='user_a_id', related_name='conversations_as_user_a')
    user_b = models.ForeignKey(settings.AUTH_USER_MODEL, models.RESTRICT, db_column='user_b_id', related_name='conversations_as_user_b',)
...
class Message(models.Model):
    message_id = UnsignedBigAutoField(primary_key=True, db_column='message_id')
    conversation = models.ForeignKey('messaging.Conversation', models.CASCADE, db_column='conversation_id')
    sender_user = models.ForeignKey(settings.AUTH_USER_MODEL, models.RESTRICT, db_column='sender_user_id')
    message_text = models.TextField(db_column='message_text')
    sent_at = models.DateTimeField(default=timezone.now, db_column='sent_at')
